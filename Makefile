...
${INC}/feature-sets.h ${INC}/hash-set.h  ${INC}/mapping-unit.h\
${INC}/morpho-analyzer.h ${INC}/read-feature.h ${INC}/trans-structs.h\
${INC}/morpho-synth-fa.h 

OBJECTS     =\
${OBJ}/trans.o ${OBJ}/prune.o ${OBJ}/and.o\
...
${OBJ}/print-util.o ${OBJ}/feature-sets.o ${OBJ}/hash-set.o ${OBJ}/mapping-unit.o\
${OBJ}/morpho-analyzer.o ${OBJ}/morpho-synth-fa.o\
${OBJ}/read-feature.o

${BIN}/trans: ${OBJECTS}
		${CC} ${CLDFLAGS} ${OBJECTS} -o ${BIN}/trans 

${OBJ}/trans.o: ${SRC}/trans.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/trans.c -o ${OBJ}/trans.o

${OBJ}/feature-sets.o: ${SRC}/feature-sets.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/feature-sets.c -o ${OBJ}/feature-sets.o
${OBJ}/hash-set.o: ${SRC}/hash-set.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/hash-set.c -o ${OBJ}/hash-set.o
${OBJ}/mapping-unit.o: ${SRC}/mapping-unit.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/mapping-unit.c -o ${OBJ}/mapping-unit.o
${OBJ}/morpho-analyzer.o: ${SRC}/morpho-analyzer.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/morpho-analyzer.c -o ${OBJ}/morpho-analyzer.o
${OBJ}/morpho-synth-fa.o: ${SRC}/morpho-synth-fa.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/morpho-synth-fa.c -o ${OBJ}/morpho-synth-fa.o
${OBJ}/read-feature.o: ${SRC}/read-feature.c ${INCLUDES} 
		${CC} ${CFLAGS} -I${INC} ${SRC}/read-feature.c -o ${OBJ}/read-feature.o
